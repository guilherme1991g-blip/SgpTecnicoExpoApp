...
export const FinancialScreen: React.FC<Props> = ({
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {/* MODAL MENU HAMBÚRGUER COM O MÓDULO FINANCEIRO */}
      <Modal
        visible={isMenuOpen}
        transparent={true}
        animationType="fade"
          ...
          <View style={styles.drawerContent}>
            ...
            <View style={styles.drawerMenuItems}>
              ...
              >
                ...
                <View style={{ flex: 1 }}>
                  <Text style={styles.menuItemText}>Abrir OS</Text>
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.7}
              >
                <View style={[styles.menuItemIconCircle, { backgroundColor: 'rgba(16, 185, 129, 0.2)' }]}>
                  <Feather name="dollar-sign" size={18} color="#10B981" />
                </View>
                <View style={{ flex: 1 }}>
                  <Text style={[styles.menuItemText, { color: '#10B981', fontWeight: 'bold' }]}>
                    Financeiro
                  </Text>
